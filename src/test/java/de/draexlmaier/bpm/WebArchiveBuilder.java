...
public class WebArchiveBuilder
{
     ...
     * @return {@link WebArchiveBuilder}
     */
    public WebArchiveBuilder addCommonConfigFiles()
    {
    ...
    public WebArchiveBuilder addBeansXml(final String filePath)
    {
        if(this.getClass().getResource("/" + filePath) != null)
        {
            this.archive.addAsResource(filePath, "META-INF/beans.xml");
        }
        return this;
    }
     ...
     * @return {@link WebArchiveBuilder}
     */
    public WebArchiveBuilder addDBUnitFiles(final String parentDir)
    {
        final File parent = new File(parentDir);
        if(parent.exists())
        {
            for(final File filePath : parent.listFiles())
            {
                this.archive.addAsResource(filePath);
            }
        }
    ...
    public static class ExlusionFilter
    {
        ...
        {
            return new ExlusionFilter().exclude(".*/Test.*").exclude(".*/.*Test.class").exclude(".*/common/.*");
        }
